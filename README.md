...
I build software for realworld use  industrial security testing platforms, ML pipelines running on edge devices and microcontrollers, research tools used across university labs, and self-hosted infrastructure that I run and maintain myself.

## What I've worked on

- **Industrial cybersecurity** — Protocol fuzzing, cross-protocol fuzzing, and desktop testing platforms built with PySide6 and FastAPI 
- **Embedded & ML** — Sensor firmware, BLE streaming, TinyML deployment, and a Flutter app with on-device inference
- **Research software** — Vue.js and Python GTK apps for scientific data management.
- **Enterprise software** — Finance-domain applications with ASP.NET Core, REST APIs, and database engineering
